...
var fr = () => {
  ...
  St = (() => {
    let e = !1,
      t = ({ message: r, lineno: n, colno: o, filename: i, error: l }) => ({
        message: r,
        lineno: n,
        colno: o,
        filename: i,
    ...
    return () => {
      ...
      fr();
      let o = (l) =>
          r.has(l) ? !0 : (r.add(l), setTimeout(() => r.delete(l), 5e3), !1),
        i = (l) => {
          let a = n(l);
          if (o(a)) return;
          let s = t(l);
...
function ae(e, t = {}, r = new WeakMap(), n = "root") {
  let o = { ...mr, ...t };
  if (n.split(".").length > o.maxDepth)
    return new U("MaxDepthReached", `[Max depth of ${o.maxDepth} reached]`);
  if (e === void 0) return new U("undefined", "undefined");
  if (e === null) return null;
  if (typeof e == "string")
    return e.length > o.maxStringLength
      ? new U(
          "String",
          `${e.slice(0, o.maxStringLength)}... [${
            e.length - o.maxStringLength
          } more characters]`
        )
      : e;
  if (typeof e == "number")
    return Number.isNaN(e)
      ...
      : Number.isFinite(e)
      ? e
      : new U("Number", e > 0 ? "Infinity" : "-Infinity");
  ...
  if (e instanceof WeakMap || e instanceof WeakSet)
    return new U(e.constructor.name, "[" + e.constructor.name + "]");
  if (e instanceof Set) {
    let s = Array.from(e);
    return s.length > o.maxArrayLength
      ? new U("Set", {
          values: s
            ...
            .map((c, d) => ae(c, o, r, `${n}.Set[${d}]`)),
          truncated: s.length - o.maxArrayLength,
        })
      : new U("Set", {
          values: s.map((c, d) => ae(c, o, r, `${n}.Set[${d}]`)),
        });
  }
  if (e instanceof Map) {
    let s = {},
    ...
    for (let [u, m] of e.entries()) {
      ...
      let h =
        typeof u == "object"
          ? JSON.stringify(ae(u, o, r, `${n}.MapKey`))
          : String(u);
  ...
  return (
    ...
    l.length > o.maxObjectKeys &&
      ((a = l.length - o.maxObjectKeys), (i["..."] = `${a} more properties`)),
    i
  );
}
...
`));
          ...
          let i = n.map((l) =>
            ae(l, { maxDepth: 5, includeSymbols: !0, preserveTypes: !0 })
          );
          _({
            type: "CONSOLE_OUTPUT",
            level: gr[r],
...
var vt = () => {
  let e = (t) => {
    !t?.origin ||
      !t?.data?.type ||
      !v.ALLOWED_ORIGINS.includes(t.origin) ||
      (t.data.type === "NAVIGATE" &&
        (t.data.direction === "back"
          ? window.history.back()
          : t.data.direction === "forward" && window.history.forward()));
  };
...
function Mr(e, t) {
  ...
  for (var o = []; n(Rr), !(r >= t.length); ) {
    var i = n(Nr);
    if (i.slice(-1) === ",")
      (i = be(e, i.substring(0, i.length - 1))), o.push(i);
    else {
      var l = "";
      i = be(e, i);
      for (var a = !1; ; ) {
...
function st(e, t, r, n) {
  return r === "src" ||
    (r === "href" && n && !(t === "use" && n[0] === "#")) ||
    (r === "xlink:href" && n && n[0] !== "#") ||
    (r === "background" && n && (t === "table" || t === "td" || t === "th"))
    ? be(e, n)
    : r === "srcset" && n
    ? Mr(e, n)
    : r === "style" && n
...
function Br(e, t) {
    ...
    try {
      e.nextSibling ||
        ...
        (!((r = e.parentNode.sheet) === null || r === void 0) &&
          r.cssRules &&
          (s = Er(e.parentNode.sheet)));
    } catch (u) {
      console.warn(
        "Cannot get CSS styles from text's parentNode. Error: ".concat(u),
        e
      );
    }
    s = xe(s, it());
  ...
  return (
    ...
    !c && !d && s && at(e, n, o) && (s = i ? i(s) : s.replace(/[\S]/g, "*")),
    { type: Z.Text, textContent: s || "", isStyle: c, rootId: l }
  );
}
function Gr(e, t) {
  for (
  ...
  if (g === "link" && i) {
    var f = Array.from(r.styleSheets).find(function ($) {
      ...
      C = null;
    f && (C = rt(f)),
      C && (delete y.rel, delete y.href, (y._cssText = xe(C, f.href)));
  }
  if (
    g === "style" &&
    e.sheet &&
  ...
  if (
    ...
    if (e.__context === "2d")
      Sr(e) || (y.rr_dataURL = e.toDataURL(d.type, d.quality));
  ...
  if (g === "img" && u) {
    ...
    var te = function () {
      try {
        (Se.width = D.naturalWidth),
          (Se.height = D.naturalHeight),
          Tt.drawImage(D, 0, 0),
          (y.rr_dataURL = Se.toDataURL(d.type, d.quality));
      } catch ($) {
        console.warn(
          "Cannot inline img src=".concat(D.currentSrc, "! Error: ").concat($)
        );
      }
  ...
  if (e.type === Z.Element) {
    ...
    if (e.tagName === "meta") {
      if (
        ...
        x(e.attributes.name).match(/^description|keywords$/)
      )
        return !0;
      if (
        t.headMetaSocial &&
        (x(e.attributes.property).match(/^(og|twitter|fb):/) ||
          x(e.attributes.name).match(/^(og|twitter):/) ||
          x(e.attributes.name) === "pinterest")
      )
        return !0;
      if (
        t.headMetaRobots &&
        (x(e.attributes.name) === "robots" ||
          x(e.attributes.name) === "googlebot" ||
          x(e.attributes.name) === "bingbot")
      )
        return !0;
...
function pe(e, t) {
  ...
  if ((G.type === Z.Document || G.type === Z.Element) && re) {
    ...
    if (yr(e) && e.shadowRoot)
      for (
        var ee = 0, O = Array.from(e.shadowRoot.childNodes);
        ee < O.length;
        ee++
      ) {
        var Q = O[ee],
    ...
    removeNode(t) {
      ...
      this.head &&
        (r.previous
          ...
          : ((this.head = r.next), this.head && (this.head.previous = null)),
      ...
      (this.frozen = !1),
        ...
        (this.emit = () => {
          ...
          let t = [],
            ...
            n = (a) => {
              let s = a,
                c = he;
              for (; c === he; )
                (s = s && s.nextSibling), (c = s && this.mirror.getId(s));
              return c;
            },
            o = (a) => {
              var s, c, d, u;
              ...
              for (
                ;
                ((u =
                  (d = h?.getRootNode) === null || d === void 0
                    ? void 0
                    : d.call(h)) === null || u === void 0
                  ? void 0
              ...
              let A = pe(a, {
                ...
                onSerialize: (g) => {
                  Be(g, this.mirror) && this.iframeManager.addIframe(g),
                    Ge(g, this.mirror) &&
                      this.stylesheetManager.trackLinkElement(g),
                    Ue(a) &&
                ...
                onIframeLoad: (g, y) => {
                  this.iframeManager.attachIframe(g, y),
          ...
          for (let a of Array.from(this.movedSet.values()))
            (Dt(this.removes, a, this.mirror) &&
              !this.movedSet.has(a.parentNode)) ||
              o(a);
          for (let a of Array.from(this.addedSet.values()))
            (!Ft(this.droppedSet, a) && !Dt(this.removes, a, this.mirror)) ||
            Ft(this.movedSet, a)
              ? o(a)
            ...
            switch (t.type) {
              case "characterData": {
                ...
                !W(t.target, this.blockClass, this.blockSelector, !1) &&
                  ...
                  this.texts.push({
                    value:
                      at(t.target, this.maskTextClass, this.maskTextSelector) &&
                      r
                        ? this.maskTextFn
                          ? this.maskTextFn(r)
                          : r.replace(/[\S]/g, "*")
                ...
                if (
                  ...
                  for (let a of Array.from(r.style)) {
                    ...
                    (s !== i.style.getPropertyValue(a) ||
                      c !== i.style.getPropertyPriority(a)) &&
                      (c === "" ? (l[a] = s) : (l[a] = [s, c]));
                  }
                  for (let a of Array.from(i.style))
                    r.style.getPropertyValue(a) === "" && (l[a] = !1);
                } else
                  o.attributes[t.attributeName] = st(
                    this.doc,
                    r.tagName,
                    t.attributeName,
                    n
                    ...
                    W(t.target, this.blockClass, this.blockSelector, !1) ||
                      ...
                      (this.addedSet.has(r)
                        ...
                        : (this.addedSet.has(t.target) && n === -1) ||
                          ...
                          (this.movedSet.has(r) && this.movedMap[xt(n, o)]
                            ? ut(this.movedSet, r)
                            : this.removes.push({
                                parentId: o,
                                id: n,
                                isShadow:
                                  ge(t.target) && me(t.target) ? !0 : void 0,
                              })),
        ...
        (this.genAdds = (t, r) => {
          if (this.mirror.hasNode(t)) {
            ...
            r && this.mirror.hasNode(r) && (n = this.mirror.getId(r)),
              n &&
                n !== -1 &&
                (this.movedMap[xt(this.mirror.getId(t), n)] = !0);
          } else this.addedSet.add(t), this.droppedSet.delete(t);
          W(t, this.blockClass, this.blockSelector, !1) ||
...
function ft(e, t) {
  ...
  let i = window.MutationObserver || window.__rrMutationObserver,
    l =
      (n =
        (r = window?.Zone) === null || r === void 0 ? void 0 : r.__symbol__) ===
        null || n === void 0
        ? void 0
  ...
  let o = typeof t.mousemove == "number" ? t.mousemove : 50,
    ...
    c = Ae(
      (u) => {
        ...
        a || (a = Date.now()),
          l.push({ x: h, y: p, id: n.getId(m), timeOffset: Date.now() - a }),
          s(
            typeof DragEvent < "u" && u instanceof DragEvent
              ? w.Drag
...
function Pr({
  ...
  return (
    Object.keys(He)
      .filter(
        (c) =>
          Number.isNaN(Number(c)) && !c.endsWith("_Departed") && l[c] !== !1
      )
      .forEach((c) => {
        let d = c.toLowerCase(),
          u = s(c);
  ...
  let t = -1,
    ...
    n = Ae(() => {
      let o = Fe(),
        i = _e();
      (t !== o || r !== i) &&
        (e({ width: Number(i), height: Number(o) }), (t = o), (r = i));
    }, 200);
...
function zr({
  ...
  function d(A) {
    ...
    if (
      ...
      !g || !g.tagName || Kr.indexOf(g.tagName) < 0 || W(g, n, o, !0))
    )
      return;
    let R = g.type;
    ...
    R === "radio" &&
      ...
      t.querySelectorAll(`input[type="radio"][name="${f}"]`).forEach((C) => {
        C !== g &&
          u(C, Bt({ text: C.value, isChecked: !H, userTriggered: !1 }, c));
      });
  }
  function u(A, g) {
    let y = Gt.get(A);
  ...
  let h = (s.input === "last" ? ["change"] : ["input", "change"]).map((A) =>
      K(A, d, t)
    ),
    p = t.defaultView;
  if (!p)
...
function Pe(e) {
  ...
  function r(n, o) {
    if (
      (Ut && n.parentRule instanceof CSSGroupingRule) ||
      (Ht && n.parentRule instanceof CSSMediaRule) ||
      (Vt && n.parentRule instanceof CSSSupportsRule) ||
      (Pt && n.parentRule instanceof CSSConditionRule)
    ) {
...
function Yr(
  ...
  n.CSSStyleSheet.prototype.insertRule = function (d, u) {
    ...
    return (
      ((m && m !== -1) || (h && h !== -1)) &&
        e({ id: m, styleId: h, adds: [{ rule: d, index: u }] }),
      o.apply(this, [d, u])
    );
  };
  ...
  n.CSSStyleSheet.prototype.deleteRule = function (d) {
    ...
    return (
      ((u && u !== -1) || (m && m !== -1)) &&
        e({ id: u, styleId: m, removes: [{ index: d }] }),
      i.apply(this, [d])
    );
  };
  let l;
  ...
  n.CSSStyleSheet.prototype.replaceSync &&
    ...
    (n.CSSStyleSheet.prototype.replaceSync = function (d) {
      ...
      return (
        ((u && u !== -1) || (m && m !== -1)) &&
          e({ id: u, styleId: m, replaceSync: d }),
        a.apply(this, [d])
      );
    }));
  let s = {};
  Ut
    ...
    : (Ht && (s.CSSMediaRule = n.CSSMediaRule),
      Pt && (s.CSSConditionRule = n.CSSConditionRule),
      Vt && (s.CSSSupportsRule = n.CSSSupportsRule));
  let c = {};
  return (
          ...
          return (
            ((p && p !== -1) || (S && S !== -1)) &&
              e({
                id: p,
                styleId: S,
                adds: [{ rule: m, index: [...Pe(this), h || 0] }],
              }),
            c[d].insertRule.apply(this, [m, h])
          );
        }),
        (u.prototype.deleteRule = function (m) {
          let { id: h, styleId: p } = ue(
            this.parentStyleSheet,
            t,
            r.styleMirror
          );
          return (
            ((h && h !== -1) || (p && p !== -1)) &&
              e({ id: h, styleId: p, removes: [{ index: [...Pe(this), m] }] }),
    ...
    () => {
      (n.CSSStyleSheet.prototype.insertRule = o),
        ...
        Object.entries(s).forEach(([d, u]) => {
          (u.prototype.insertRule = c[d].insertRule),
            (u.prototype.deleteRule = c[d].deleteRule);
        });
    }
  );
}
function mt({ mirror: e, stylesheetManager: t }, r) {
  ...
  let a =
      r.nodeName === "#document"
        ? (n = r.defaultView) === null || n === void 0
          ? void 0
          : n.Document
        : (i =
            (o = r.ownerDocument) === null || o === void 0
              ? void 0
              : o.defaultView) === null || i === void 0
        ? void 0
        : i.ShadowRoot,
  ...
  return l === null || l === -1 || !a || !s
    ...
    : (Object.defineProperty(r, "adoptedStyleSheets", {
        ...
        set(c) {
          var d;
          let u =
            (d = s.set) === null || d === void 0 ? void 0 : d.call(this, c);
          if (l !== null && l !== -1)
            try {
    ...
    this.restorePatches.push(
      ne(Element.prototype, "attachShadow", function (n) {
        return function (o) {
          ...
          return (
            this.shadowRoot &&
              r.addShadowRoot(this.shadowRoot, this.ownerDocument),
            i
          );
        };
      })
      ...
      this.restorePatches.push(
        ne(t.contentWindow.HTMLElement.prototype, "attachShadow", function (n) {
          return function (o) {
            ...
            return (
              this.shadowRoot &&
                r.addShadowRoot(this.shadowRoot, t.contentDocument),
              i
            );
          };
        })
...
var Re,
  Yt = function (e) {
    ...
    for (r = 0; r < n; r += 3)
      (o += Ee[t[r] >> 2]),
        (o += Ee[((t[r] & 3) << 4) | (t[r + 1] >> 4)]),
        (o += Ee[((t[r + 1] & 15) << 2) | (t[r + 2] >> 6)]),
        (o += Ee[t[r + 2] & 63]);
    return (
      n % 3 === 2
...
function en(e, t) {
  let r = Jt.get(e);
  return (
    r || ((r = new Map()), Jt.set(e, r)), r.has(t) || r.set(t, []), r.get(t)
  );
}
var ht = (e, t, r) => {
...
function gt(e, t, r) {
  ...
  try {
    let o = ne(e.HTMLCanvasElement.prototype, "getContext", function (i) {
      return function (l, ...a) {
        return (
          W(this, t, r, !0) || "__context" in this || (this.__context = l),
          i.apply(this, [l, ...a])
        );
      };
    });
...
function Xt(e, t, r, n, o) {
  ...
  return (
    ...
    typeof t.WebGL2RenderingContext < "u" &&
      i.push(
        ...qt(t.WebGL2RenderingContext.prototype, ce.WebGL2, e, r, n, o, t)
      ),
    () => {
      i.forEach((l) => l());
    }
...
function rn(e, t) {
  var r = atob(e);
  if (t) {
    for (var n = new Uint8Array(r.length), o = 0, i = r.length; o < i; ++o)
      n[o] = r.charCodeAt(o);
...
var Je = class {
  constructor(t) {
    ...
    (this.mutationCb = t.mutationCb),
      (this.mirror = t.mirror),
      l && r === "all" && this.initCanvasMutationObserver(n, o, i),
      l &&
        typeof r == "number" &&
        this.initCanvasFPSObserver(r, n, o, i, { dataURLOptions: a });
  }
  reset() {
          ...
          m().forEach((S) =>
            zt(this, void 0, void 0, function* () {
              ...
              if ((a.set(A, !0), ["webgl", "webgl2"].includes(S.__context))) {
                ...
                ((b = y?.getContextAttributes()) === null || b === void 0
                  ? void 0
  ...
  flushPendingCanvasMutationFor(t, r) {
    ...
    let o = n.map((l) => Kt(l, ["type"])),
      { type: i } = n[0];
    this.mutationCb({ id: r, type: i, commands: o }),
  ...
  adoptStyleSheets(t, r) {
    ...
    for (let i of t) {
      ...
      if (this.styleMirror.has(i)) l = this.styleMirror.getId(i);
        ...
        o.push({
          styleId: l,
          rules: a.map((s, c) => ({ rule: nt(s), index: c })),
        });
      }
      n.styleIds.push(l);
    }
...
function Ie(e = {}) {
  ...
  B = (E, z) => {
    var Q;
    if (
      (!((Q = fe[0]) === null || Q === void 0) &&
        Q.isFrozen() &&
        E.type !== L.FullSnapshot &&
        !(E.type === L.IncrementalSnapshot && E.data.source === w.Mutation) &&
        fe.forEach((F) => F.unfreeze()),
      T)
    )
      t?.(le(E), z);
    else if (N) {
  ...
  let J = (E) => {
      B(
        V({
          type: L.IncrementalSnapshot,
          data: Object.assign({ source: w.Mutation }, E),
        })
      );
    },
    $ = (E) =>
      B(
        V({
          type: L.IncrementalSnapshot,
          data: Object.assign({ source: w.Scroll }, E),
        })
      ),
    de = (E) =>
      B(
        V({
          type: L.IncrementalSnapshot,
          data: Object.assign({ source: w.CanvasMutation }, E),
        })
      ),
    G = (E) =>
      B(
        V({
          type: L.IncrementalSnapshot,
          data: Object.assign({ source: w.AdoptedStyleSheet }, E),
        })
      ),
  ...
  je = (E = !1) => {
    ...
    let Te = Lt(document, {
      ...
      inlineImages: C,
      onSerialize: (Y) => {
        Be(Y, oe) && se.addIframe(Y),
          Ge(Y, oe) && re.trackLinkElement(Y),
          Ue(Y) && Ce.addShadowRoot(Y.shadowRoot, document);
      },
      onIframeLoad: (Y, Xe) => {
    ...
    B(
            ...
            left:
              window.pageXOffset !== void 0
                ...
                : document?.documentElement.scrollLeft ||
                  ((Q =
                    (z = document?.body) === null || z === void 0
                      ? void 0
                      : z.parentElement) === null || Q === void 0
                    ? void 0
                    : Q.scrollLeft) ||
                  ((F = document?.body) === null || F === void 0
                    ? void 0
                    : F.scrollLeft) ||
                  0,
            top:
              window.pageYOffset !== void 0
                ...
                : document?.documentElement.scrollTop ||
                  ((O =
                    (ee = document?.body) === null || ee === void 0
                      ? void 0
                      : ee.parentElement) === null || O === void 0
                    ? void 0
                    : O.scrollTop) ||
                  ((j = document?.body) === null || j === void 0
                    ? void 0
                    : j.scrollTop) ||
                  0,
          },
      ...
      document.adoptedStyleSheets &&
        ...
        re.adoptStyleSheets(document.adoptedStyleSheets, oe.getId(document));
  };
  try {
    let E = [];
    E.push(
      ...
      return Zt(
        {
          ...
          mouseInteractionCb: (O) =>
            B(
              V({
                type: L.IncrementalSnapshot,
                data: Object.assign({ source: w.MouseInteraction }, O),
              })
            ),
          scrollCb: $,
          viewportResizeCb: (O) =>
            B(
              V({
                type: L.IncrementalSnapshot,
                data: Object.assign({ source: w.ViewportResize }, O),
              })
            ),
          inputCb: (O) =>
            B(
              V({
                type: L.IncrementalSnapshot,
                data: Object.assign({ source: w.Input }, O),
              })
            ),
          mediaInteractionCb: (O) =>
            B(
              V({
                type: L.IncrementalSnapshot,
                data: Object.assign({ source: w.MediaInteraction }, O),
              })
            ),
          styleSheetRuleCb: (O) =>
            B(
              V({
                type: L.IncrementalSnapshot,
                data: Object.assign({ source: w.StyleSheetRule }, O),
              })
            ),
          styleDeclarationCb: (O) =>
            B(
              V({
                type: L.IncrementalSnapshot,
                data: Object.assign({ source: w.StyleDeclaration }, O),
              })
            ),
          canvasMutationCb: de,
          fontCb: (O) =>
            B(
              V({
                type: L.IncrementalSnapshot,
                data: Object.assign({ source: w.Font }, O),
              })
            ),
          selectionCb: (O) => {
            B(
              V({
                type: L.IncrementalSnapshot,
                data: Object.assign({ source: w.Selection }, O),
              })
            );
          },
          blockClass: o,
...
var ir = [],
  sr = () => {
    let e = Ie({
      emit(t) {
        ir.push(t),
          window.parent.postMessage({ type: "RRWEB_EVENT", event: t }, "*");
      },
...
var Me = (e) =>
  ...
  Oe = (e) => {
    let t = e.getAttribute("data-lov-id") || "",
      ...
      a = Array.from(e.children)
        ...
        .filter(
          (s, c, d) => c === d.findIndex((u) => q(u).filePath === q(s).filePath)
        )
        .map((s) => ({
  ...
  dr = () => {
    ...
    let n = () => {
      ...
      o = (f) => {
        if (!(!t.tooltip || !f))
          try {
            ...
            if (((t.tooltip.style.maxWidth = `${v.MAX_TOOLTIP_WIDTH}px`), I))
              (t.tooltip.style.left = v.FULL_WIDTH_TOOLTIP_OFFSET),
                (t.tooltip.style.top = v.FULL_WIDTH_TOOLTIP_OFFSET);
            else {
              let k = Math.max(0, C.top - v.TOOLTIP_OFFSET);
              (t.tooltip.style.left = `${Math.max(0, C.left)}px`),
                (t.tooltip.style.top = `${k}px`);
            }
      ...
      i = (f) => {
        let C =
          Math.abs(f.getBoundingClientRect().width - window.innerWidth) < 5;
        f.setAttribute(v.HOVERED_ATTR, "true"),
          C && f.setAttribute("data-full-width", "true");
      },
      l = (f) => {
        f.removeAttribute(v.HOVERED_ATTR),
          f.removeAttribute("data-full-width"),
          (f.style.cursor = "");
      },
      a = (f) => {
      ...
      s = r((f) => {
        if (
          !t.isActive ||
          !Me(f.target) ||
          f.target.tagName.toLowerCase() === "html" ||
          a(f.target)
        )
          return;
        t.hoveredElement &&
        ...
        t.isActive &&
          (t.hoveredElement &&
            ((t.hoveredElement && b(q(t.hoveredElement)))?.forEach((C) => {
              C.removeAttribute(v.HOVERED_ATTR),
                C.hasAttribute(v.SELECTED_ATTR) || l(C);
            }),
      ...
      S = () => {
        document.removeEventListener("mouseover", s),
          ...
          t.hoveredElement &&
            (t.hoveredElement.hasAttribute(v.SELECTED_ATTR) ||
              l(t.hoveredElement),
            (t.hoveredElement = null)),
          d();
      },
      ...
      A = (f) => {
        try {
          if (
            !f?.origin ||
            !f?.data?.type ||
            !v.ALLOWED_ORIGINS.includes(f.origin)
          )
            return;
          switch (f.data.type) {
                      ...
                      document
                        ...
                        .forEach((I) => {
                          I.removeAttribute("disabled"),
                            I.setAttribute("data-lov-disabled", "");
                        });
                    }))
                  : (S(),
                    document
                      ...
                      .forEach((k) => {
                        k.removeAttribute("data-lov-disabled"),
                          k.setAttribute("disabled", "");
                      }),
                    document
                      .querySelectorAll(
                        `[${v.HOVERED_ATTR}], [data-full-width]`
                      )
                      .forEach((k) => {
                        k.hasAttribute(v.SELECTED_ATTR) ||
                          (l(k),
                          k instanceof HTMLElement && (k.style.cursor = ""));
                      }),
                    t.reset()));
              break;
            case "UPDATE_SELECTED_ELEMENTS":
              ...
              document
                .querySelectorAll(`[${v.SELECTED_ATTR}], [${v.HOVERED_ATTR}]`)
                .forEach((I) => {
                  I.removeAttribute(v.SELECTED_ATTR),
                    I.removeAttribute(v.HOVERED_ATTR),
                    I.removeAttribute("data-full-width");
                }),
                f.data.payload.forEach((I) => {
                  ...
                  b({
                    ...
                    T.setAttribute(v.SELECTED_ATTR, "true"),
                      Math.abs(
                        T.getBoundingClientRect().width - window.innerWidth
                      ) < 5 && T.setAttribute("data-full-width", "true");
                  });
                });
              break;
            ...
            case "DUPLICATE_ELEMENT_REQUESTED": {
              ...
              b({ filePath: I.path, lineNumber: I.line }).forEach((T) => {
                let N = T.cloneNode(!0);
                N.setAttribute("data-lov-id", "x"),
                  N.setAttribute("data-lov-tmp", "true"),
              ...
              b({ filePath: I.path, lineNumber: I.line }).forEach((T) => {
                ...
                let N = () => {
                    _({
                      ...
                      payload: { id: I, content: T.innerText },
                    });
                  },
                  D = () => {
            ...
            case "GET_PARENT_ELEMENT": {
              let { id: I } = f.data.payload,
                N = b({ filePath: I.path, lineNumber: I.line })[0]
                  .parentElement;
              !N || N.id === "root" || ["HTML", "BODY"].includes(N.tagName)
                ? _({ type: "PARENT_ELEMENT", payload: null })
                : _({ type: "PARENT_ELEMENT", payload: Oe(N) });
              break;
            }
      ...
      y = () => {
        _({ type: "REQUEST_PICKER_STATE" }),
          _({ type: "REQUEST_SELECTED_ELEMENTS" });
      };
    (() => {
      try {
        n(),
    ...
    let P = (f) => {
        if (
          ...
          (f.preventDefault(), f.stopPropagation(), t.hoveredElement)
        ) {
          let C = Oe(t.hoveredElement);
          t.hoveredElement.setAttribute(v.SELECTED_ATTR, "true"),
            Math.abs(
              t.hoveredElement.getBoundingClientRect().width - window.innerWidth
            ) < 5 && t.hoveredElement.setAttribute("data-full-width", "true"),
            _({
              type: "ELEMENT_CLICKED",
              payload: C,
              isMultiSelect: f.metaKey || f.ctrlKey,
            });
        }
      },
      H = (f) => {
