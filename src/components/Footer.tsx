  ...
  return (
    <footer className="bg-navy-950 text-white py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <Link to="/" className="text-2xl font-playfair font-bold">
              Dev<span className="text-accent-300">Portfolio</span>
            </Link>
            ...
            <div className="flex mt-4 space-x-4">
              ...
              <a
                href="https://instagram.com/mr_reyan_shoaib"
                target="_blank"
                rel="noreferrer"
                className="text-gray-400 hover:text-white transition-colors"
              >
              ...
              <a
                href="mailto:reyanshoaib45@gmail.com"
                className="text-gray-400 hover:text-white transition-colors"
              >
                <Mail className="h-5 w-5" />
              </a>
              <a
                href="tel:+92 346 4769301"
                className="text-gray-400 hover:text-white transition-colors"
              >
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400 font-lato">
          <p>
            &copy; {new Date().getFullYear()} M Reyan SHoaib. All rights
            reserved.
          </p>
        </div>
      </div>
