        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="mb-6 flex justify-center animate-fade-in">
            <Avatar className="h-32 w-32 border-4 border-navy-600 shadow-lg transition-transform hover:scale-105 duration-300">
              <AvatarImage
                src="/src/components/pic/hi.jpg"
                alt="M Reyan SHoaib"
              />
              <AvatarFallback className="bg-gradient-to-br from-navy-500 to-accent-500 text-white text-2xl">
                MRS
              </AvatarFallback>
            </Avatar>
          </div>
          ...
          <div className="relative">
            <h2
              className="text-2xl md:text-3xl font-bold mb-6 text-navy-700 min-h-[40px] font-playfair"
              ref={textRef}
            >
              Full Stack Developer
            </h2>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center animate-fade-in">
            <Link to="/#projects">
              <Button className="bg-gradient-to-r from-navy-600 to-navy-800 hover:from-navy-700 hover:to-navy-900 text-white px-6 py-3 rounded-md font-medium transition-all duration-300 flex items-center gap-2 hover:scale-105">
                View My Work{" "}
                <ArrowRight className="h-4 w-4 animate-bounce-light" />
              </Button>
            </Link>
            <Link to="/contact">
              <Button
